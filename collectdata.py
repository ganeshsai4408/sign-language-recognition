...
while True:
    ...
    count = {
             ...
             'y': len(os.listdir(directory+"/all-the-best")),
             'z': len(os.listdir(directory+"/hello"))
             }
    ...
    if interrupt & 0xFF == ord('y'):
        cv2.imwrite(directory+'all-the-best/'+str(count['y'])+'.png',frame)
    if interrupt & 0xFF == ord('z'):
        cv2.imwrite(directory+'hello/'+str(count['z'])+'.png',frame)
